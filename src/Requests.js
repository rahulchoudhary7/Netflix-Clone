const process.env.API_KEY = "1ab1ca12e4e2d2eeb3148de65178f7fe";
...
const requests = {
     ...
     fetchTopRated:`/movie/top_rated?api_key=${process.env.API_KEY}&language=en-US&page=1`,
     ...
     fetchRomanticMovies: `/discover/movie?api_key=${process.env.API_KEY}&with_genres=10749`,
